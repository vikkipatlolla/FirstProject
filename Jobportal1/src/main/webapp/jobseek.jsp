                 ...
                 <ul class="nav navbar-nav navbar-right">
                  <li class="dropdown">
                             <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                  <p>Welcome <?jsp echo $_SESSION['email']; ?>!</p>
                              </a> 
...
<form class="form-horizontal" role="form" method="post" action="seekupdate.php" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <div class="col-sm-10">
<input type="text" class="form-control" id="fname" name="fname" placeholder="Enter your First Name" value="<?jsp echo $data2['fname'];?>">
  ...
  <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="lname" name="lname" placeholder="Enter your Last Name" value="<?jsp echo $data2['lname']?>">
        </div>
    </div>
<div class="form-group">
  ...
  <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="headline" name="headline" placeholder="Web developer with 3.5+ yrs experience" value="<?jsp echo $data2['headline']?>">
        </div>
    </div>
    <div class="form-group">
        <label for="name" class="col-sm-2 control-label">Location</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="cloc" name="cloc" placeholder="Enter your Location" value="<?jsp echo $data2['cloc']?>">
        </div>
    </div>
    <div class="form-group">
        <label for="name" class="col-sm-2 control-label">Contact Num</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" id="contnum" name="contnum" placeholder="Enter your Contact Number " value="<?jsp echo $data2['contnum']?>">
        </div>
    </div>
  <div class="form-group">
  ...
  <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="skilltest" name="skilltest" placeholder="Ex: Java , HTML , CSS" value="<?jsp echo $data2['skilltest']?>">
        </div>
    </div>
    <div class="form-group">
